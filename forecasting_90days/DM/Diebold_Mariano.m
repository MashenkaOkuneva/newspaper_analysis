...
% between different models over three forecast horizons. The script evaluates 
...
%fe_ms_model1 = csvread('..\combination\forecast_errors_combination_dfm_text_hard_10stable_equal.csv', 1, 0); 
...
%fe_ms_model2 = csvread('..\MIDAS\forecast_errors_midas_ridge_1lags_hard.csv', 1, 0); 
