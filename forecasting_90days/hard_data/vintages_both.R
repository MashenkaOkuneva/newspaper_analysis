...
# 10. Finally, the script generates indicators for nowcasting 
...
# The main function
prepare_vintage <- function(vintage, date_h, sample_start = c("1992-01-01"), Ntopics = 10,
  ...
  #list_topics_select <- c("T27", "T127", "T11", "T138", "T52", "T81", "T74", "T100",
  #                        "T77", "T88")
  # 5 most correlated and meaningful topics
  #list_topics_select <- c("T27", "T127", "T11", "T138", "T52")
  # 15 most correlated and meaningful topics
  #list_topics_select <- c("T27", "T127", "T11", "T138", "T52", "T81", "T74", "T100",
  #                        "T77", "T88", "T179", "T136", "T58", "T168", "T129")
  ...
  #list_topics_select <- c("T11", "T127", "T27", "T52", "T74", "T81", "T138", "T100")
  # 6 stable topics
  #list_topics_select <- c("T11", "T127", "T27", "T52", "T74", "T81")
  ...
  # export to csv
  write.csv(df_data, file = paste0("./vintages_both/", "vint_", year(vintage), "_", month(vintage), "_", day(vintage), ".csv"),
            row.names = F,
            quote = F,
            na = "NaN")
...
if(!dir.exists("./vintages_both")) {
  dir.create("./vintages_both")
}
