# This script constructs a series of actual GDP growth values based on the first 
# release data for the evaluation period (2009-12-31 to 2018-12-31) of the 
...
# Save to CSV
write.csv(df_gdp_fr, "gdp_growth.csv", row.names = FALSE)
