...
%   a) `nowcasts_hard_1fac_no_trafo_1345_li.csv`
%   b) `forecasts_1step_hard_1fac_no_trafo_1345_li.csv`
%   c) `forecasts_2step_hard_1fac_no_trafo_1345_li.csv`
%-------------------------------------------------------------------------%
...
parfor i = 1:length(files)
    [n, f1, f2, dn, df1, df2] = run_forecast_hard(files(i).name, dir_path, 1, 10);
