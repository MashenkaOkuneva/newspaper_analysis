...
%   a) `nowcasts_both_2fac_K_30_10_stable.csv`
%   b) `forecasts_1step_both_2fac_K_30_10_stable.csv`
%   c) `forecasts_2step_both_2fac_K_30_10_stable.csv`
%-------------------------------------------------------------------------%
...
parfor i = 1:length(files)
    [n, f1, f2, dn, df1, df2] = run_forecast_both(files(i).name, dir_path, 2, 10);
