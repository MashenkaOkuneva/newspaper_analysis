...
# and text-based predictors. Ridge regression is applied for dimensionality reduction
# by shrinking the coefficients of less important predictors from a set
# of financial/economic series and monthly sign-adjusted topics.
...
# The same number of lags is applied uniformly across all predictors, though the starting point may differ 
# depending on data availability for the hard and text-based series.
# The script reads in a single vintage and generates Ridge-based forecasts for each horizon.
