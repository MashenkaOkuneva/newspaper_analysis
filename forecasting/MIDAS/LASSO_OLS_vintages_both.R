...
# LASSO is applied for dimensionality reduction to select the most relevant predictors from both data sources.
...
# generating OLS-based forecasts across all horizons using the LASSO-selected 
# predictors and a fixed number of lags (p). 
# The same number of lags is applied uniformly across all predictors, 
# though the starting point may differ depending on data availability 
...
write.table(backcasts_df, "backcasts_midas_lasso_ols_both.csv", row.names = FALSE, col.names=FALSE, sep=",", quote=FALSE)
write.table(nowcasts_df, "nowcasts_midas_lasso_ols_both.csv", row.names = FALSE, col.names=FALSE, sep=",", quote=FALSE)
write.table(forecasts_1step_df, "forecasts_1step_midas_lasso_ols_both.csv", row.names = FALSE, col.names=FALSE, sep=",", quote=FALSE)
write.table(forecasts_2step_df, "forecasts_2step_midas_lasso_ols_both.csv", row.names = FALSE, col.names=FALSE, sep=",", quote=FALSE)