...
# coefficients of less important predictors from both data sources.
...
# generating Ridge-based forecasts across all horizons using a fixed number of lags (p).
...
write.table(backcasts_df, "backcasts_midas_ridge_both.csv", row.names = FALSE, col.names=FALSE, sep=",", quote=FALSE)
write.table(nowcasts_df, "nowcasts_midas_ridge_both.csv", row.names = FALSE, col.names=FALSE, sep=",", quote=FALSE)
write.table(forecasts_1step_df, "forecasts_1step_midas_ridge_both.csv", row.names = FALSE, col.names=FALSE, sep=",", quote=FALSE)
write.table(forecasts_2step_df, "forecasts_2step_midas_ridge_both.csv", row.names = FALSE, col.names=FALSE, sep=",", quote=FALSE)