...
# algorithm from Stock and Watson (2002) to extract common factors from the combined set of 
# text and financial/economic data. 
# The implementation is tested across different forecasting horizons (backcasts, nowcasts, 
# 1-step-ahead, and 2-step-ahead forecasts) and across different numbers of lags applied 
# uniformly to the extracted factors.
...
#eigvals_pca <- eigen(cor(all_series, use = "complete.obs"), only.values = T)
...
#     main = "eigenvalue decomposition of all_series")
