# This script implements forecasting using a MIDAS model that incorporates both hard economic data 
# and text-based predictors. Principal Component Analysis (PCA) is used for dimensionality reduction, 
# applying the EM algorithm from Stock and Watson (2002) to extract common factors from both 
# the financial/economic series and monthly sign-adjusted topics. 
...
# The same number of lags is applied uniformly to the extracted factors. 
