...
# and text-based predictors. LASSO is applied for dimensionality reduction to select the most relevant 
# variables from a set of financial/economic series and monthly sign-adjusted topics, which are then 
# used in an Ordinary Least Squares (OLS) regression for prediction.
