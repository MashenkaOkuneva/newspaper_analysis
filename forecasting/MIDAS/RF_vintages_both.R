...
# between the predictors from both data sources and the target variable.
...
write.table(backcasts_df, "backcasts_midas_rf_both.csv", row.names = FALSE, col.names=FALSE, sep=",", quote=FALSE)
write.table(nowcasts_df, "nowcasts_midas_rf_both.csv", row.names = FALSE, col.names=FALSE, sep=",", quote=FALSE)
write.table(forecasts_1step_df, "forecasts_1step_midas_rf_both.csv", row.names = FALSE, col.names=FALSE, sep=",", quote=FALSE)
write.table(forecasts_2step_df, "forecasts_2step_midas_rf_both.csv", row.names = FALSE, col.names=FALSE, sep=",", quote=FALSE)