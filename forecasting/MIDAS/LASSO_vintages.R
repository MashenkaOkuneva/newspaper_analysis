...
write.table(backcasts_df, "backcasts_midas_lasso_all_topics_0lag.csv", row.names = FALSE, col.names=FALSE, sep=",", quote=FALSE)
write.table(nowcasts_df, "nowcasts_midas_lasso_all_topics_0lag.csv", row.names = FALSE, col.names=FALSE, sep=",", quote=FALSE)
write.table(forecasts_1step_df, "forecasts_1step_midas_lasso_all_topics_0lag.csv", row.names = FALSE, col.names=FALSE, sep=",", quote=FALSE)
write.table(forecasts_2step_df, "forecasts_2step_midas_lasso_all_topics_0lag.csv", row.names = FALSE, col.names=FALSE, sep=",", quote=FALSE)