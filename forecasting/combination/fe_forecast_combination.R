# This script combines forecasts from two different DFM models: one using only text data 
...
backcasts_m1 <- read.csv(file.path("../DFM/model", "backcasts_choose_10stable_1fac_K_30.csv"), header = FALSE, stringsAsFactors = FALSE)
...
backcasts_m2 <- read.csv(file.path("../DFM/model", "backcasts_hard_1fac_no_trafo_1345_li.csv"), header = FALSE, stringsAsFactors = FALSE)
...
write.csv(combined_errors, file.path(current_dir, "forecast_errors_combination_dfm_text_hard_10stable_equal.csv"), row.names = FALSE)