# This script creates plots of AR(1) forecasts for all forecasting horizons 
...
# The plots compare each AR(1) forecast against the actual GDP growth and are saved as separate PDF files.
...
backcasts <- read.csv("backcasts_ar1.csv", header = FALSE, stringsAsFactors = FALSE)
...
generate_plot(backcasts, "Backcasts vs. GDP Growth", "backcasts_plot_ar1.pdf")
generate_plot(nowcasts, "Nowcasts vs. GDP Growth", "nowcasts_plot_ar1.pdf")
generate_plot(forecasts_1step, "One-step-ahead Forecasts vs. GDP Growth", "forecasts_1step_plot_ar1.pdf")
generate_plot(forecasts_2step, "Two-step-ahead Forecasts vs. GDP Growth", "forecasts_2step_plot_ar1.pdf")