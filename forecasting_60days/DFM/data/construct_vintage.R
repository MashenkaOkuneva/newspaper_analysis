...
# 9. Finally, the script generates indicators for nowcasting 
...
vintage <- c("2010-02-28")
#vintage <- c("2018-05-28")
...
# <- paste0("./correlations/vint_", year(vintage), "_", month(vintage), "_", day(vintage), "_correlations_20.csv")
